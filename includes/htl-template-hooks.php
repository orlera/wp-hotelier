...
add_action( 'hotelier_room_list_item_title', 'hotelier_template_room_list_title', 10 );
add_action( 'hotelier_room_list_item_guests', 'hotelier_template_rooms_left', 20, 4 );
