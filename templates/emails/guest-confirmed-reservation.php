<?php
/**
 * Guest confirmed reservation email (HTML)
 *
 * This template can be overridden by copying it to yourtheme/hotelier/emails/guest-confirmed-reservation.php
 *
...
<tr>
	<td style="text-align:left;font-size:15px;line-height:19px;color:#999999;font-family:Helvetica,Arial;"><?php printf( esc_html__( 'Hello %s, your reservation has been confirmed. Your reservation details are shown below for your reference.', 'wp-hotelier' ), $reservation->get_formatted_guest_full_name() ); ?></td>
</tr>
<tr>
